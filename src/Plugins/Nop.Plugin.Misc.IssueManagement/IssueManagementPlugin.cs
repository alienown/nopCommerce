    ...
    public class IssueManagementPlugin : BasePlugin, IAdminMenuPlugin, IMiscPlugin
    {
        ...
        public override void Install()
        {
            _localizationService.AddLocaleResource(new Dictionary<string, string>
            {
                ...
                ["Plugins.Misc.IssueManagement.List.ChartsPanel.Title"] = "Charts",
                ["Plugins.Misc.IssueManagement.List.ChartsPanel.IssueCountPerStatusChartPanel.Title"] = "Issue count per status",
                ["Plugins.Misc.IssueManagement.List.ChartsPanel.IssueCountPerPriorityChartPanel.Title"] = "Issue count per priority",
