    ...
    public class IssueManagementPlugin : BasePlugin, IAdminMenuPlugin, IMiscPlugin
    {
        ...
        public override void Install()
        {
            _localizationService.AddLocaleResource(new Dictionary<string, string>
            {
                ...
                ["Plugins.Misc.IssueManagement.Edit.Title"] = "Edit issue",
                ["Plugins.Misc.IssueManagement.Edit.EditNewIssue"] = "Edit issue",
                ...
                ["Plugins.Misc.IssueManagement.Edit.PersonsInvolvedPanel.Title"] = "PersonsInvolved",
